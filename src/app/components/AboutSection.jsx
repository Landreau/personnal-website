...
const TAB_DATA = [
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>Electronic System</li>
        <li>Programming Language: C, C++, C#, Java, Python, .NET</li>
        <li>Database: Oracle, Postgrsql, Sqlite</li>
        <li>JavaScript</li>
        <li>React</li>
      </ul>
    ),
      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          ...
          <p className="text-base lg:text-lg">
            I am a technician in embedded systems (IOT Projects) but with a passion for web applications and software development. I have experience
            working with C#, C, C++, Lua, React, Java, Postgrsql, Oracle, Sqlite, HTML, CSS, and Git. I am a quick learner and I am always
